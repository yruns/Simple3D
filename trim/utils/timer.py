...
class Timer:
    """
    A timer which computes the time elapsed since the start.sh/reset of the timer.
    """
    ...
    def seconds(self) -> float:
        """
        Returns:
            (float): the total number of seconds since the start.sh/reset of the
    ...
    def avg_seconds(self) -> float:
        """
        Returns:
            (float): the average number of seconds between every start.sh/reset and
            pause.
        """
